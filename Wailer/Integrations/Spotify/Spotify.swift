...
@objc public protocol SpotifyApplication: SBApplicationProtocol {
    ...
    @objc optional func playTrack(_ x: NSString!, inContext: Any!) // Start playback of a track in the given context.
    ...
    @objc optional var name: NSString { get } // The name of the application.
    @objc optional var frontmost: Bool { get } // Is this the frontmost (active) application?
    @objc optional var version: NSString { get } // The version of the application.
}
extension SBApplication: SpotifyApplication {}

// MARK: SpotifyTrack
@objc public protocol SpotifyTrack: SBObjectProtocol {
    @objc optional var artist: NSString { get } // The artist of the track.
    @objc optional var album: NSString { get } // The album of the track.
    ...
    @objc optional var name: NSString { get } // The name of the track.
    @objc optional var artworkUrl: NSString { get } // The URL of the track%apos;s album cover.
    @objc optional var artwork: NSImage { get } // The property is deprecated and will never be set. Use the 'artwork url' instead.
    @objc optional var albumArtist: NSString { get } // That album artist of the track.
    @objc optional var spotifyUrl: NSString { get } // The URL of the track.
    @objc optional func setSpotifyUrl(_ spotifyUrl: NSString) // The URL of the track.
}
